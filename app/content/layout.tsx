  ...
  return (
    <div className="drawer drawer-end z-50">
      ...
      <div className="drawer-content flex flex-col">
        {/* Navbar */}
        <div className="w-full navbar fixed h-20 flex justify-between items-center z-50">
          ...
          <div className="flex-1 px-2 mx-2">
            <Image src="/image.png" alt="Logo image" width={60} height={60} className='rounded-lg shadow-md' />
          </div>
