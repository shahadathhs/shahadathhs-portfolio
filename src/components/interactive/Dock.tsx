        ...
        {SECTIONS.map((s, i) => {
          ...
          return (
            <button
              ...
              title={`${s.label} — ${i + 1}`}
              className={`group relative flex h-10 w-10 cursor-pointer items-center justify-center rounded-full transition-colors duration-200 ${
                isActive
                  ? 'text-background'
            ...
            >
              ...
              <Icon className="relative z-10 h-4.5 w-4.5" strokeWidth={2.2} />
